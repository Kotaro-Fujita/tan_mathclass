...
\arabic{kaunta}}}} \hspace{1pt} 次の説明に当てはまる言葉を答えなさい。

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} 数直線上で0が対応する点
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} 原点からの距離 \hfill*
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(+8\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-10\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(+2.5\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-\dfrac{1}{5}\) \hfill*
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-2, \, -3\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(0, \, +1, \, -2\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-8, \, 9\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-4, \, +3, \, -1\) \hfill*
