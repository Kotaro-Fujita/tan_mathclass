...
\arabic{kaunta}}}} \hspace{1pt} 次の説明にあう言葉を答えなさい。

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} 正の整数
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} 1とその数自身の積でしか表わせない自然数

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} 自然数を素数だけの積で表すこと \hfill 
...
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt}210
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt}57
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt}360 \hfill
