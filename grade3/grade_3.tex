...
\arabic{skaunta}})\hspace{2.5pt} \((-6) +(-3)\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-9)+(+8)\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((+2) - (+9)\) \hfill (4)
\((-6) - (+7)\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-7 +3\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(3 +(-10)\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(3 -8\)
\hfill (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-5 - (-9)\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(2.4 - 3.5\) \hfill 
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(\dfrac{3}{4} - \biggl( -\dfrac{5}{12} \biggl)\)
\hfill  (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-4 + 9 -3\) \hfill 

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-8) + (+5) + (-3) + (+8) + (-1) + (-5) + (+3) + (+3) + (+7) + (-2) + (-8)\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-4) \times (-8)\) \hspace{30mm}
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-18) \div 3\) \hspace{30mm}
(\text{\refstepcounter{skaunta}%
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-12) \div \biggl(-\dfrac{2}{5} \biggl)\)
\hspace{30mm} (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-2) \times (-9) \times 3\)
\hspace{30mm} (\text{\refstepcounter{skaunta}%
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-6) \times 2 \times (-4) \times (-5)\)
\hspace{30mm} (\text{\refstepcounter{skaunta}%
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-14) \times 3 \div \biggl(-\dfrac{7}{4} \biggl)\)
\hspace{30mm} (\text{\refstepcounter{skaunta}%
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(7 + 45 \div (-3)\) \hspace{50mm}
(\text{\refstepcounter{skaunta}%
...
(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-2)^3 + (-5) \times 2\)
\hspace{50mm} (\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \((-6)^2 \div (-9) - 8\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(9 - 4 \times (5 -8)\) \hspace{50mm}
(\text{\refstepcounter{skaunta}%
