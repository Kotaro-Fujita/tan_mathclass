...
\arabic{skaunta}})\hspace{2.5pt} \(6x - x\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-3x -8x\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(2x - 8 + 4x\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-5y -8y + 6y\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(-x + 1 - 8x + 3\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(4x - 3 - 7x + 2\)
