...
\arabic{kaunta}}}} \hspace{1pt} 10から20までの整数のうち、素数をすべて書きなさい。
...
\arabic{skaunta}})\hspace{2.5pt}40

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt}170

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt}81

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt}360
