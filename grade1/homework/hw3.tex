...
\arabic{kaunta}}}} \hspace{1pt} 次の分数を素因数分解を利用して約分しなさい。

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(\dfrac{42}{56}\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(\dfrac{15}{45}\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(\dfrac{56}{91}\)

\vfill

(\text{\refstepcounter{skaunta}%
\arabic{skaunta}})\hspace{2.5pt} \(\dfrac{24}{40}\)
